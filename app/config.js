/*
yang bisa di ubah ubah icon ( Ryuu Artexy )
=========================
fas fa-rocket
fas fa-bolt
...
const products = [
    {
        ...
        items: [
            { value: 'panel-1gb', name: 'Paket 1 GB', price: 500, specs: 'CPU Load: 30%, Memory: 512MB', badge: 'Termurah' },
            { value: 'panel-2gb', name: 'Paket 2 GB', price: 1000, specs: 'CPU Load: 60%, Memory: 1GB', badge: 'Termurah' },
            { value: 'panel-3gb', name: 'Paket 3 GB', price: 2000, specs: 'CPU Load: 120%, Memory: 2GB', badge: 'Termurah' },
            { value: 'panel-4gb', name: 'Paket 4 GB', price: 3000, specs: 'CPU Load: 240%, Memory: 4GB', badge: 'Termurah' },
            { value: 'panel-5gb', name: 'Paket 5 GB', price: 4000, specs: 'CPU Load: 480%, Memory: 8GB', badge: 'Termurah' },
...
const faqData = [
    {
        question: 'Apa itu RyuuHost?',
        answer: '<ul>RyuuHost adalah penyedia layanan hosting terkemuka yang berfokus pada panel Pterodactyl untuk server game dan aplikasi. Kami menawarkan hosting berkualitas premium dengan harga terjangkau dan performa optimal.</ul>'
    },
    {
        question: 'Bagaimana cara membeli hosting di RyuuHost?',
        answer: '<ul>Untuk membeli hosting, Anda perlu mengisi "Informasi Akun" Anda, memilih "Paket Hosting" yang diinginkan, memilih "Metode Pembayaran" (QRIS, Gopay, atau DANA), lalu memeriksa "Ringkasan Pesanan". Setelah itu, klik tombol "BELI" untuk melanjutkan konfirmasi pembayaran dan aktivasi layanan melalui WhatsApp Admin RyuuHost.</ul>'
    },
    {
    ...
    {
        question: 'Apakah RyuuHost menyediakan layanan support?',
